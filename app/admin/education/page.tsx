  ...
  return (
    <Container>
            ...
            <CardContent>
              <CardHeader>
                <div>
                  ...
                  <CardSubtitle>{edu.degree}</CardSubtitle>
                  <CardDate>{edu.date}</CardDate>
                </div>
                <ActionButtons>
              ...
              <CardDescription>{edu.desc}</CardDescription>
            </CardContent>
          </Card>
        ))}
      </Grid>
      ...
      <Modal isOpen={isModalOpen}>
        <ModalContent>
          <ModalHeader>
            <ModalTitle>{editingItem ? 'Edit' : 'Add'} Education</ModalTitle>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <FormGroup>
              ...
              {errors.school && <ErrorMessage>{errors.school.message}</ErrorMessage>}
            </FormGroup>
            ...
            <FormGroup>
              ...
              {errors.grade && <ErrorMessage>{errors.grade.message}</ErrorMessage>}
            </FormGroup>
