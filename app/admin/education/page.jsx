...
export default function EducationManagementPage() {
  ...
  const onSubmit = async (data) => {
    ...
    const payload = {
      ...data,
      img: schoolImage,
      order: editingItem?.order ?? educationList.length,
    };
          ...
          <Card key={edu._id}>
            ...
            <CardContent>
              <CardHeader>
                ...
                <ActionButtons>
                  <IconButton onClick={() => handleOpenModal(edu)}>
                    <FiEdit2 />
                  </IconButton>
                  <IconButton
                    variant="delete"
        ...
        <ModalContent>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <FormGroup>
              ...
              <ImageUploadButton
                type="button"
                onClick={() => document.getElementById("school-image")?.click()}
              >
                <FiUpload />
                {isUploading
                  ? "Uploading..."
            ...
            <FormGroup>
              ...
              />
              {errors.degree && (
                <ErrorMessage>{errors.degree.message}</ErrorMessage>
              )}
            </FormGroup>
