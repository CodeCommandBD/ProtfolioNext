    ...
    <Container id="Contact">
      <Wrapper>
        ...
        <ContactForm onSubmit={handleSubmit(onSubmit)}>
          ...
          <ContactInput placeholder="Your Email" type="email" {...register('email')} />
          ...
          <ContactInputMessage placeholder="Message" rows={4} {...register('message')} />
          ...
          {submitSuccess && <SuccessMessage>✓ Message sent successfully!</SuccessMessage>}
        </ContactForm>
      </Wrapper>
    </Container>
  );
